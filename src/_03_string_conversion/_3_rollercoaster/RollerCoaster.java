...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		String heightToRide = JOptionPane.showInputDialog("Enter your heigh in inches (no units just number)");
		// Uncomment the line below...
		int heightAsInt = Integer.parseInt(heightToRide);
		if(heightAsInt > 48) { 
			JOptionPane.showMessageDialog(null, "Yay! you are tall enough to ride by yourself!");
		} else if (heightAsInt > 41) {
			JOptionPane.showMessageDialog(null, "You can ride, but first find an adult");
		}
		else {
			JOptionPane.showMessageDialog(null, "you must be at least 42 inches tall to ride the roller coaster.");
		}
