...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			JOptionPane.showMessageDialog(null, "4 + 6 = "+ fourAsString + sixAsString);
			...
			JOptionPane.showMessageDialog(null, "4 + 6 + 5 = "+ fourAsString + sixAsString + fiveAsString);
			...
			JOptionPane.showMessageDialog(null, "4 + 6 = "+ (fourAsInt + sixAsInt));
			...
			int fiveAsInt = Integer.parseInt(sixAsString);
			// 10) Print the addition of fourAsInt, sixAsInt, and fiveAsInt using JOptionPane 
			JOptionPane.showMessageDialog(null, "4 + 6 + 5 = "+ (fourAsInt + sixAsInt + fiveAsInt));
